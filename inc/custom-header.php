...
function tuhh_institute_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'tuhh_institute_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'tuhh_institute_header_style',
		'admin-head-callback'    => 'tuhh_institute_admin_header_style',
		'admin-preview-callback' => 'tuhh_institute_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'tuhh_institute_custom_header_setup' );

if ( ! function_exists( 'tuhh_institute_header_style' ) ) :
/**
...
endif; // tuhh_institute_header_style

if ( ! function_exists( 'tuhh_institute_admin_header_style' ) ) :
/**
...
endif; // tuhh_institute_admin_header_style

if ( ! function_exists( 'tuhh_institute_admin_header_image' ) ) :
/**
